...
exports.DocumentProfileDocumentPage = void 0;
var core_1 = require("@angular/core");
var DocumentProfileDocumentPage = /** @class */ (function () {
    function DocumentProfileDocumentPage(modalController, _service, navParams) {
    ...
    DocumentProfileDocumentPage.prototype.ngOnInit = function () {
    };
    DocumentProfileDocumentPage.prototype.ionViewWillEnter = function () {
        console.log('docs');
        this.userData = JSON.parse(localStorage.getItem('userData'));
        this.getCatalogs();
    };
    DocumentProfileDocumentPage.prototype.getCatalogs = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.privacy = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this._service.getCatalogueFrom('GetDocumentStatus')];
                    case 2:
    ...
    DocumentProfileDocumentPage.prototype.back = function () {
        var back = document.getElementById('back');
        back.play();
        this.modalController.dismiss();
    };
    DocumentProfileDocumentPage.prototype.doc = function () {
        document.getElementById('doc').click();
    };
    DocumentProfileDocumentPage.prototype.dropped = function (files) {
        var _this = this;
        this.files = files;
    ...
    DocumentProfileDocumentPage.prototype.fileOver = function (event) {
        console.log(event);
    };
    DocumentProfileDocumentPage.prototype.fileLeave = function (event) {
        console.log(event);
    };
    DocumentProfileDocumentPage.prototype.getDataToLibrarySettings = function () { };
    DocumentProfileDocumentPage.prototype.save = function () {
    ...
    DocumentProfileDocumentPage = __decorate([
        core_1.Component({
    ...
    ], DocumentProfileDocumentPage);
    return DocumentProfileDocumentPage;
}());
exports.DocumentProfileDocumentPage = DocumentProfileDocumentPage;
