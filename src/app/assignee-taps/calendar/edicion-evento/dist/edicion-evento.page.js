...
exports.EdicionEventoPage = void 0;
var core_1 = require("@angular/core");
var general_mensage_page_1 = require("src/app/dialog/general-mensage/general-mensage.page");
var EdicionEventoPage = /** @class */ (function () {
    function EdicionEventoPage(router, _permissions, loader, modalController, _services) {
        this.router = router;
    ...
    EdicionEventoPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EdicionEventoPage.prototype.save = function () {
        var _this = this;
        console.log("SAVE DATA: ", this.appointment);
        debugger;
        this._services.service_general_post_with_url("Appointment/UpdateAppointment", this.appointment).subscribe((function (data) {
            if (data.success) {
                console.log(data);
    ...
    EdicionEventoPage.prototype.general_messages = function (data) {
    ...
    EdicionEventoPage.prototype.back = function () {
    ...
    EdicionEventoPage.prototype.Scroll = function (event) {
        this._services.onScroll(event);
    };
    EdicionEventoPage = __decorate([
        core_1.Component({
    ...
    return EdicionEventoPage;
}());
exports.EdicionEventoPage = EdicionEventoPage;
