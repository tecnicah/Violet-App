...
var RenewalPage = /** @class */ (function () {
    function RenewalPage(router, _permissions, loader, modalController, _services) {
        this.router = router;
    ...
    //**************************************************************************************************//
    RenewalPage.prototype.ionViewWillEnter = function () {
    ...
    //*********************************************//
    //SORT REMINDER//
    RenewalPage.prototype.sortData = function () {
        return this.renewal.reminderRenewals.sort(function (a, b) {
            return new Date(a.reminderDate) - new Date(b.reminderDate);
        });
    };
    //**************************************************************************************************//
    //CONSULTA DE  REQUEST PAYMENTS//
    RenewalPage.prototype.request = function () {
        var _this = this;
    ...
    RenewalPage.prototype.getCatalogos = function () {
    ...
    RenewalPage.prototype.addDocument = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data.success) {
                                data.data.renewalId = _this.renewal.id;
                                data.data.comment = "";
    ...
    RenewalPage.prototype.deleteDocument = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('ImmigrationServices/DeleteDocumentR?id=' + id).subscribe(function (r) {
                                        if (r.success) {
    ...
    RenewalPage.prototype.addComment = function () {
    ...
    //**************************************************************************************************//
    //FUNCION PARA AGREGAR REPLICA//
    RenewalPage.prototype.addReminder = function () {
    ...
    //**************************************************************************************************//
    //FUNCION PARA ELIMINAR DOCUMENTOS//
    RenewalPage.prototype.deleteReminder = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('ImmigrationServices/DeleteReminderR?id=' + id).subscribe(function (r) {
                                        if (r.success) {
                                            _this.general_messages({
                                                title: "Success",
                                    ...
                                    _this.renewal.reminderRenewals.splice(i, 1);
                                }
                            }
                        });
                        this.modalController.dismiss();
    ...
    RenewalPage.prototype.save = function () {
        ...
        this._services.service_general_put("ImmigrationServices/PutRenewal", this.renewal).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                _this.general_messages({
                    title: "Success",
    ...
    RenewalPage.prototype.general_messages = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    //**************************************************************************************************//
    //FUNCION PARA GUARDAR INFORMACION//
    RenewalPage.prototype.back = function () {
        /*
    ...
    RenewalPage.prototype.getCoordinator = function () {
        var _this = this;
    ...
    RenewalPage.prototype.getConsultant = function () {
        var _this = this;
    ...
    RenewalPage.prototype.Scroll = function (event) {
...
exports.RenewalPage = RenewalPage;
