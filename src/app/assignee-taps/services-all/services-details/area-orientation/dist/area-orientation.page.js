...
exports.AreaOrientationPage = void 0;
...
var AreaOrientationPage = /** @class */ (function () {
    function AreaOrientationPage(router, _permissions, loader, modalController, _services) {
        this.router = router;
    ...
    //***************************************************************************//
    AreaOrientationPage.prototype.ionViewWillEnter = function () {
    ...
    AreaOrientationPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    //**************************************************************************//
    //SORT REMINDER//
    AreaOrientationPage.prototype.sortData = function () {
        return this.area.reminderAreaOrientations.sort(function (a, b) {
            return new Date(a.reminderDate) - new Date(b.reminderDate);
        });
    };
    AreaOrientationPage.prototype.getCatalogos = function () {
    ...
    AreaOrientationPage.prototype.getDataHousing = function () {
        var _this = this;
    ...
    //***************************************************************************//
    AreaOrientationPage.prototype.getDataSchool = function () {
        var _this = this;
    ...
    AreaOrientationPage.prototype.getPayment = function () {
        var _this = this;
    ...
    AreaOrientationPage.prototype.addDocument = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data.success) {
                                data.data.areaOrientationId = _this.area.id;
                                data.data.comment = "";
    ...
    AreaOrientationPage.prototype.deleteDocument = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('RelocationServices/DeleteDocumentAO?id=' + id).subscribe(function (r) {
                                        if (r.success) {
    ...
    AreaOrientationPage.prototype.addComment = function () {
    ...
    //***************************************************************************//
    //FUNCION PARA AGREGAR REPLICA//
    AreaOrientationPage.prototype.addReminder = function () {
    ...
    AreaOrientationPage.prototype.deleteReminder = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('RelocationServices/DeleteReminderAO?id=' + id).subscribe(function (r) {
                                        if (r.success) {
                                            _this.general_messages({
                                                title: "Success",
                                    ...
                                    _this.area.reminderAreaOrientations.splice(i, 1);
                                }
                            }
                        });
                        this.modalController.dismiss();
    ...
    //***************************************************************************//
    //NACIONALITY//
    AreaOrientationPage.prototype.getNacionality = function (id) {
    ...
    //***************************************************************************//
    //GRADE//
    AreaOrientationPage.prototype.getGrade = function (id) {
    ...
    //***************************************************************************//
    //AGREGAR HIJO//
    AreaOrientationPage.prototype.addChild = function (e, pos) {
        console.log(e);
    ...
    //***************************************************************************//
    //DELETE CHILD//
    AreaOrientationPage.prototype.deleteChild = function (pos) {
        this.area.schoolingAreaOrientations[pos].active = false;
        this.general_messages({
            title: "Success",
    ...
    AreaOrientationPage.prototype.save = function () {
        var _this = this;
        this.loader.loadingPresent();
        ...
        var data_comment_aux = this.area.commentAreaOrientations;
        ...
        this._services.service_general_put("RelocationServices/PutAreaOrientation", this.area).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                _this.general_messages({
                    title: "Success",
    ...
    //***************************************************************************//
    //FUNCION PARA GUARDAR INFORMACION//
    AreaOrientationPage.prototype.back = function () {
        /*
    ...
    AreaOrientationPage.prototype.general_messages = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AreaOrientationPage.prototype.getCoordinator = function () {
        var _this = this;
    ...
    ;
    AreaOrientationPage.prototype.getConsultant = function () {
        var _this = this;
    ...
    //**********************************************************************//
    AreaOrientationPage.prototype.Scroll = function (event) {
        this._services.onScroll(event);
    };
    AreaOrientationPage = __decorate([
        core_1.Component({
    ...
    return AreaOrientationPage;
}());
exports.AreaOrientationPage = AreaOrientationPage;
