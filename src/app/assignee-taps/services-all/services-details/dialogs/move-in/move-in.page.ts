...
@Component({
  ...
  templateUrl: './move-in.page.html',
  styleUrls: ['./move-in.page.scss'],
})
export class MoveInPage implements OnInit {
  ...
  public userData: any;
  constructor(public loader:LoadingService,public navParams: NavParams, public modalController: ModalController, public _services: GeneralService, private camera: Camera, public actionSheetController: ActionSheetController) { }
  ...
  postReport() {
    ...
    this.data_moveIn.propertyInspection = 1;
