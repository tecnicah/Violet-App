...
@Component({
  selector: 'app-other-immigration',
  templateUrl: './other-immigration.page.html',
  styleUrls: ['./other-immigration.page.scss'],
})
export class OtherImmigrationPage implements OnInit {
