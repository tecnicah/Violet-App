...
exports.LegalReviewPage = void 0;
...
var LegalReviewPage = /** @class */ (function () {
    function LegalReviewPage(router, _permissions, loader, modalController, _services) {
        this.router = router;
        ...
        this.renewal = {
            documentLegalReviews: [],
            reminderLegalReviews: [],
            commentLegalReviews: []
        };
        this.data = {};
        this.ca_visaType = [];
    ...
    //**************************************************************************************************//
    LegalReviewPage.prototype.ionViewWillEnter = function () {
    ...
    LegalReviewPage.prototype.ngOnInit = function () {
        var _this = this;
        this.loader.loadingPresent();
        this.getCatalogos();
        //this.data = this.navParams.data;
        this.data = JSON.parse(localStorage.getItem('data_service'));
        this._services.service_general_get("ImmigrationServices/GetLegalReviewById?id=" + this.data.service[0].id)
            .subscribe(function (response) {
            console.log(response);
            if (response.success) {
                console.log(response.result);
                _this.renewal = response.result;
                _this.sortData();
    ...
    //*********************************************//
    //SORT REMINDER//
    LegalReviewPage.prototype.sortData = function () {
        return this.renewal.reminderLegalReviews.sort(function (a, b) {
            return new Date(a.reminderDate) - new Date(b.reminderDate);
        });
    };
    //**************************************************************************************************//
    //CONSULTA DE  REQUEST PAYMENTS//
    LegalReviewPage.prototype.request = function () {
        var _this = this;
        this._services.service_general_get("RequestPayment/GetRequestedPayments?WorkOrderServicesId=" + this.renewal.workOrderServicesId).subscribe((function (data) {
            if (data.success) {
    ...
    LegalReviewPage.prototype.getCatalogos = function () {
    ...
    LegalReviewPage.prototype.addDocument = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data.success) {
                                data.data.legalReviewId = _this.renewal.id;
                                data.data.comment = "";
    ...
    LegalReviewPage.prototype.deleteDocument = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('ImmigrationServices/DeleteDocumentLR?id=' + id).subscribe(function (r) {
                                        if (r.success) {
    ...
    LegalReviewPage.prototype.addComment = function () {
        this.renewal.commentLegalReviews.push({
            "id": 0,
            "legalReviewId": this.renewal.id,
    ...
    //**************************************************************************************************//
    //FUNCION PARA AGREGAR REPLICA//
    LegalReviewPage.prototype.addReminder = function () {
        this.renewal.reminderLegalReviews.push({
            "id": 0,
            "legalReviewId": this.renewal.id,
    ...
    //**************************************************************************************************//
    //FUNCION PARA ELIMINAR DOCUMENTOS//
    LegalReviewPage.prototype.deleteReminder = function (id, i) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data) {
                                if (id != 0) {
                                    _this._services.service_general_delete('ImmigrationServices/DeleteReminderLR?id=' + id).subscribe(function (r) {
                                        if (r.success) {
                                            _this.general_messages({
                                                title: "Success",
                                    ...
                                    _this.renewal.reminderLegalReviews.splice(i, 1);
                                }
                            }
                        });
                        this.modalController.dismiss();
    ...
    LegalReviewPage.prototype.save = function () {
        var _this = this;
        this.loader.loadingPresent();
        this.renewal.updatedDate = new Date();
        this.renewal.updateBy = new Date();
        this.renewal.documentLegalReviews = this.temporalDocument;
        var data_comment_aux = this.renewal.commentLegalReviews;
        this.renewal.commentLegalReviews = [];
        for (var i = 0; i < data_comment_aux.length; i++) {
            if (data_comment_aux[i].reply != null && data_comment_aux[i].reply != undefined && data_comment_aux[i].reply.trim() != '') {
                data_comment_aux[i].user.profileUsers = [];
                this.renewal.commentLegalReviews.push(data_comment_aux[i]);
            }
        }
        console.log(this.renewal);
        this._services.service_general_put("ImmigrationServices/PutLegalReview", this.renewal).subscribe((function (data) {
            if (data.success) {
                console.log(data);
                _this.general_messages({
                    title: "Success",
                    body: "Legal Review was updated",
                    success: true
                });
                _this.loader.loadingDismiss();
    ...
    LegalReviewPage.prototype.general_messages = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    //**************************************************************************************************//
    //FUNCION PARA GUARDAR INFORMACION//
    LegalReviewPage.prototype.back = function () {
        /*
    ...
    LegalReviewPage.prototype.getCoordinator = function () {
        var _this = this;
    ...
    ;
    LegalReviewPage.prototype.getConsultant = function () {
        var _this = this;
    ...
    LegalReviewPage.prototype.Scroll = function (event) {
        this._services.onScroll(event);
    };
    LegalReviewPage = __decorate([
        core_1.Component({
            selector: 'app-legal-review',
            templateUrl: './legal-review.page.html',
            styleUrls: ['./legal-review.page.scss']
        })
    ], LegalReviewPage);
    return LegalReviewPage;
}());
exports.LegalReviewPage = LegalReviewPage;
